...
public class ApiExplorer {
    public static String main(String baseDate, String baseTime, String nx, String ny) throws IOException, JSONException {
        ...
        for(int i=0;i<jsonArray.length();i++){
            ...
            if(category.equals("SKY") && weather == null){ // 1: 맑음, 2: 비, 3: 구름, 4: 흐린
                weather = fcstValue;
            }
            if(category.equals("T1H") && temperature == null){ // 현재 기온
                temperature = fcstValue+"℃";
            }
        }
        Log.d(TAG,"SKY => "+weather +", TMP => "+temperature);
